...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener {
    ...
    protected static ISDLClipboardHandler mClipboardHandler;
...
//             "SDL2_net",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SDLActivity.nativeSetenv("SDCARD", Environment.getExternalStorageDirectory().getAbsolutePath());
        SDLActivity.nativeSetenv("EXTERNAL_FILES_DIR", getExternalFilesDir(null).getAbsolutePath());
...
interface ISDLClipboardHandler {
